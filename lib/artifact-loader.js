 ...
 *   - hooks/ is flat executable .js plus hooks.json, copied verbatim by
 *     installHooks() in adapters/claude/index.js. It never had a manifest, so
 *     the `hook` kind this map used to declare was unreachable: loadArtifacts
 *     only descends into subdirectories and hooks/ has none.
