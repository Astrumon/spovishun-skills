---
name: diagram-design
description: Use this skill to generate editorial-quality technical diagrams as standalone HTML + inline SVG files — Clean Architecture layer diagrams, flowcharts, sequence diagrams, ER schemas, state machines, swimlanes, and more. Outputs save to docs/diagrams/ for git versioning. Triggers: "діаграма", "схема", "architecture diagram", "flowchart", "ER схема", "sequence diagram", "state machine", "swimlane", "намалюй діаграму", "побудуй схему".
license: MIT
metadata:
  version: "1.0"
---
...
> **HTML escaping rule:** `&` inside an HTML `href` attribute must be written as `&amp;`. Every separator in a multi-parameter Google Fonts URL must use `&amp;`, not bare `&`.
...
2. **Diagram container** — default: clean, borderless.
